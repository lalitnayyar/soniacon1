...
//Connection Settings @0-516E2074
$CCConnectionSettings = array (
    "Connection1" => array(
        "Type" => "MySQL",
        "DBLib" => "MySQL",
        "Database" => "symbiyjz_saapp",
        "Host" => "symbioticindia.in",
        "Port" => "3306;Database=symbiyjz_saapp",
        "User" => "symbiyjz_saapp",
        "Password" => "sharda@23",
        "Persistent" => false,
...
//Initialize Common Variables @0-C02E3606
