<?php
//Include Common Files @1-F6087435
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "thankyou.php");
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "thankyou.html";
$BlockToParse = "main";
